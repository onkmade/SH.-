        ...
        modal.innerHTML = `
            <div style="background: white; padding: 2rem; border-radius: 8px; max-width: 600px; max-height: 90vh; overflow-y: auto;">
                ...
                <div style="margin: 1rem 0;">
                    <img src="/uploads/products/${product.images[0]?.split('/').pop()}" alt="${product.title}" style="max-width: 100%; border-radius: 6px;">
                </div>
                <p style="color: #28a745; font-weight: bold;">${verified}</p>
                <p style="margin: 0.5rem 0;"><strong>Price:</strong> $${product.price}</p>
                <p style="margin: 0.5rem 0;"><strong>Condition:</strong> ${product.condition}</p>
                <p style="margin: 0.5rem 0;"><strong>Category:</strong> ${product.category}</p>
                <p style="margin: 0.5rem 0;"><strong>Location:</strong> ${product.location}</p>
                <p style="margin: 0.5rem 0;"><strong>Description:</strong> ${product.description}</p>
                <p style="margin: 0.5rem 0;"><strong>Seller:</strong> ${product.seller_name}</p>
                <p style="margin: 0.5rem 0;"><strong>Contact:</strong> ${product.seller_contact}</p>
                <p style="margin: 0.5rem 0; color: #666; font-size: 0.9rem;"><strong>Views:</strong> ${product.views}</p>
